...
Together they provide the AppID, title, platforms, Metacritic score, localized description, release date, developers, publishers, genres, artwork, and screenshots. Library cards try Steam's vertical library capsule first and fall back to the background artwork when loading it fails.
